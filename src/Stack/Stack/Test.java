...
// Bài 62: Hiểu rõ về cách sử dụng Stack trong Java
/**
 Cáu trúc kiểu first in last out : Vào đầu tiên ra sau cùng
...
public class Test {
    ...
    stackChuoi.push(s.charAt(i) + "");
      ...
      Stack<String>  stackSoDu = new Stack<String>();
        ...
        int n = stackSoDu.size();  // Kích thước của stack

        for(int i=0; i< n; i++){
            System.out.print(stackSoDu.pop());  // Sau mỗi lần là stackSoDu.size liên tục thay đổi nhỏ dần
        }
    }
}