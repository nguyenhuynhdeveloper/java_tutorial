...
/**
 Bải 61: Bài tập quản lý danh sách sinh viên ntrong Java sử dụng ArrayList

 - ArrayList sử dụng rất nhiều trong thực tế
 ...
 - Xoá 1 sinh viên ra khỏi danh sách dựa theo mã sinh viên
 - Tìm kiến tất cả sinh viên dựa trên Tên được nhập từ bàn phím
...
public class Test {
    public static void main(String[] args) {
        ...
        do {
            ...
            luaChon = sc.nextInt();  // Cho người dùng nhập số int từ bàn phím
            sc.nextLine();  // Nhận phím enter -- Do có 2 sc cạnh nhau

            if(luaChon==1) {
//				1.	Thêm sinh viên vào danh sách.
                System.out.println("Nhập mã sinh viên: "); String maSinhVien = sc.nextLine();   // Nhận giá trị mã sinh viên -- Bấm phím enter là kết thúc nhận
